...
def test_create_user_new_email(
    ...
    with (
        patch("ndastro_api.email_helper.send_email", return_value=None),
        patch("ndastro_api.core.config.settings.SMTP_HOST", "smtp.example.com"),
        patch("ndastro_api.core.config.settings.SMTP_USER", "admin@example.com"),
    ):
        ...
        assert httpx.codes.OK <= r.status_code < httpx.codes.MULTIPLE_CHOICES
        created_user = r.json()
...
def test_update_user_me_email_exists(
    ...
    assert r.status_code == httpx.codes.CONFLICT
